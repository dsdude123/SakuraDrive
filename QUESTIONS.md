...
711 tests green: 577 Node (163 shared, 377 server, 37 UI) and 134 Pester for the agent.
...
The Pester suite now runs here too, not just in CI: 134 tests against the real `dpcmd`,
