...
disks drive letters — folder mount points turned out not to work through WSL2, and §5a
has the finding and the one command that does.
...
742 tests green: 577 Node (163 shared, 377 server, 37 UI) and 165 Pester for the agent.
...
The Pester suite now runs here too, not just in CI: 165 tests against the real `dpcmd`,
